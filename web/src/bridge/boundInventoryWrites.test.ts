...
test("R102 — a SetLabel new-label return is carried through untouched", () => {
  const ack = decodeInventoryWriteAck(plainAck({ ok: true, applied: true, result: "My Rifter" }));
